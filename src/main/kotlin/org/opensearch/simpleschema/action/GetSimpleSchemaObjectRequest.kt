...
import org.opensearch.simpleschema.model.RestTag.FILTER_PARAM_LIST_FIELD
 ...
 */
class GetSimpleSchemaObjectRequest : ActionRequest, ToXContentObject {
    val objectIds: Set<String>
    val types: EnumSet<SimpleSchemaObjectType>
    val fromIndex: Int
    val maxItems: Int
    ...
    companion object {
        private val log by logger(GetSimpleSchemaObjectRequest::class.java)

        /**
         * reader to create instance of class from writable.
         */
        val reader = Writeable.Reader { GetSimpleSchemaObjectRequest(it) }
        ...
        fun parse(parser: XContentParser): GetSimpleSchemaObjectRequest {
            ...
            while (parser.nextToken() != XContentParser.Token.END_OBJECT) {
                ...
                when (fieldName) {
                    ...
                    OBJECT_TYPE_FIELD -> types = parser.enumSet(SimpleSchemaObjectType.enumParser)
            ...
            return GetSimpleSchemaObjectRequest(
                objectIdList,
                types,
                fromIndex,
                maxItems,
    ...
    constructor(
        ...
        types: EnumSet<SimpleSchemaObjectType> = EnumSet.noneOf(SimpleSchemaObjectType::class.java),
        fromIndex: Int = 0,
    ...
    constructor(input: StreamInput) : super(input) {
        ...
        types = input.readEnumSet(SimpleSchemaObjectType::class.java)
