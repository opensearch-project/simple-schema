 ...
 */
internal class GetSimpleSchemaObjectResponse : BaseResponse {
    ...
    companion object {
         ...
         */
        val reader = Writeable.Reader { GetSimpleSchemaObjectResponse(it) }
        ...
        fun parse(parser: XContentParser): GetSimpleSchemaObjectResponse {
            return GetSimpleSchemaObjectResponse(SimpleSchemaObjectSearchResult(parser), false)
        }
    }
     ...
     */
    constructor(searchResult: SimpleSchemaObjectSearchResult, filterSensitiveInfo: Boolean) {
    ...
    constructor(input: StreamInput) : super(input) {
        searchResult = SimpleSchemaObjectSearchResult(input)
