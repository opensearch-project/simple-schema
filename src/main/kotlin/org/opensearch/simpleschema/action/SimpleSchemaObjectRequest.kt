 ...
 */
internal class SimpleSchemaObjectRequest : ActionRequest, ToXContentObject {
    val objectIds: Set<String>

    companion object {
        private val log by logger(SimpleSchemaObjectRequest::class.java)

        /**
         * reader to create instance of class from writable.
         */
        val reader = Writeable.Reader { SimpleSchemaObjectRequest(it) }
        ...
        fun parse(parser: XContentParser): SimpleSchemaObjectRequest {
            ...
            return SimpleSchemaObjectRequest(objectIds)
        }
    }
