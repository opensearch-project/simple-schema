...
package org.opensearch.simpleschema.settings
...
import org.opensearch.simpleschema.SimpleSchemaPlugin.Companion.PLUGIN_NAME
...
internal object PluginSettings {
     ...
     */
    private const val DEFAULT_ADMIN_ACCESS_METHOD = "AllSimpleSchemaObjects"
     ...
     */
    internal enum class AdminAccess { Standard, AllSimpleSchemaObjects }
    ...
    init {
        ...
        if (configDirName != null) {
            val defaultSettingYmlFile = Path.of(configDirName, PLUGIN_NAME, "simpleschema.yml")
            try {
