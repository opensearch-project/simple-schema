...
package org.opensearch.simpleschema.security

import org.opensearch.OpenSearchStatusException
import org.opensearch.commons.authuser.User
import org.opensearch.simpleschema.settings.PluginSettings
import org.opensearch.simpleschema.settings.PluginSettings.FilterBy
...
internal object UserAccessManager {
    ...
    private fun canAdminViewAllItems(user: User): Boolean {
        return PluginSettings.adminAccess == PluginSettings.AdminAccess.AllSimpleSchemaObjects && isAdminUser(user)
    }
