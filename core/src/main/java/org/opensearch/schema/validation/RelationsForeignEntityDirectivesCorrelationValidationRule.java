 ...
 * <br>
 * if the relation directive states FOREIGN it must dictate that the both entities mapping must be @model (STATIC) - since foreign relationship can't reference the same index (as the source of the relationship)
 * <br>
 * see docs/physical-mapping.md for additional explanation
 */
public class RelationsForeignEntityDirectivesCorrelationValidationRule implements ValidationRule {
